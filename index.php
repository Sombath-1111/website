...
<body class="home">
						...
						if(empty($_SESSION["user_id"])) // if user is not login
							{
							  ...
							  <li class="nav-item"><a href="qr.php" class="nav-link active">QR</a> </li>';
    ...
    <section class="hero bg-image" data-image-src="images/img/backround.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
            <h1><span style="color:Yellow;">Order Delivery & Take-Out</span> </h1>
